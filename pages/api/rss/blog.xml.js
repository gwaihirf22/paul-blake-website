...
export default function handler(req, res) {
  ...
  try {
    const feed = new Feed({
      title: 'Paul Blake - Blog Posts',
      description: 'Latest blog posts about development, technology, and more',
      ...
      updated: new Date(),
      feedLinks: {
        rss2: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://paulblake.dev'}/api/rss/blog.xml`,
      },
      author: {
        name: 'Paul Blake',
    ...
    // Get all blog posts (excluding theology posts)
    ...
    posts.forEach(post => {
      feed.addItem({
        title: post.title,
        id: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://paulblake.dev'}/blog/${post.slug}`,
        link: `${process.env.NEXT_PUBLIC_SITE_URL || 'https://paulblake.dev'}/blog/${post.slug}`,
